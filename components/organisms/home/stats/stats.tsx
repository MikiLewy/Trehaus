...
const Stats = () => {
  return (
    <section className="vertical-section-spacing content-container">
      <SectionTitle className="md:text-center">Zaufaj naszemu doświadczeniu</SectionTitle>
      <div className="flex flex-col justify-start gap-6 mt-6 md:justify-between md:flex-row md:mt-10 xl:mt-20 ">
        {stats.map(stat => (
          <div key={stat.key} className="flex flex-col gap-1 md:text-center md:basis-1/4 md:items-center">
            <h4 className="font-semibold text-5xl md:text-6xl lg:text-7xl xl:text-8xl">

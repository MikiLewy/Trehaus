...
const Textarea = ({ label, errorMessage, value, onChange, required, ...other }: Props) => {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <textarea rows={4} className={mergedClasses} required={required} value={value} onChange={onChange} {...other} />

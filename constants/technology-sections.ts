  ...
  [
    {
      ...
      details: [
        ...
        },
        {
          key: 'wood-fiber',
          title:
            'Izolacja steico zell z włókna drzewnego',
          description:
    ...
    },
    {
      key: 'house-roof',
      title:
        'Dach domu z poddaszem użytkowym',
      img: {
        src: '/technology/dach-domu-uzytkowego.png',
      ...
      details: [
        ...
        },
        {
          key: 'system-rafters',
          title:
            'Krokwie w systemie MITEK lub belki dwuteowe',
          description:
    ...
    },
    {
      ...
      img: {
        src: '/technology/dach-domu-parterowego.png',
      ...
      details: [
        {
          key: 'layer-of-finish',
          title:
            'Warstwa wykończenia na ruszcie drewnianym',
          description:
            'Do wykończenia wnętrz mamy dwie opcje do wyboru. Pierwsza opcja to płyty gipsowe Rigips 4 pro o podwyższonej odporności ogniowej, szpachlowane do standardu Q2 lub opcjonalnie Q4. Druga opcja to wykończenie panelami drewnianymi. W ofercie mamy kilka rodzajów do wyboru. W pomieszczeniach o podwyższonej wilgotności stosujemy płyty o odpowiednim przeznaczeniu.',
        },
        {
        ...
        },
        {
          key: 'system-rafters',
          title:
            'Wiązary dachowe w systemie MI-TEK',
          description:
